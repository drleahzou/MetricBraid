...
[watchlist](https://github.com/drleahzou/MetricBraid/blob/main/evidence/watchlist.yaml) are for.
...
[`routed-observation.md`](routed-observation.md); the short
form:
...
| **D** | Self-reported intake | ⚪ Outside the capability model — declared, not sensed | Graded by capture method, not by a dossier | *(see the skill's Rule D section)* |
...
1. Something surfaces — a new study, new firmware, a device change.
   [`.github/workflows/evidence-watch.yml`](https://github.com/drleahzou/MetricBraid/blob/main/.github/workflows/evidence-watch.yml)
   checks [watchlist.yaml](https://github.com/drleahzou/MetricBraid/blob/main/evidence/watchlist.yaml) every Monday and opens an issue
